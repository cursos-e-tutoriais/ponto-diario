...
class HomeController extends GetxController {
  ...
  checkPermission() async {
    ...
    if (permission == LocationPermission.deniedForever){
      return Future.error('O serviço de localização foi desabilitado permanentemente. Nós não podemos ter acesso a sua localização!');
    }
    ...
    if (permission == LocationPermission.denied){
      ...
      if (permission != LocationPermission.whileInUse &&
          permission != LocationPermission.always){
            return Future.error('O serviço de localização está desabilitado (permissão atual: $permission).');
          }
    }
